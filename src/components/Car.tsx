    ...
    return (
        <div className="bg-white border border-gray-100 rounded-2xl hover:shadow-lg transition">
            ...
            <div className="px-4 py-3">
                {/* TITLE */}
                <h1 className="text-sm md:text-md lg:text-2xl font-bold text-gray-800">
                    {car.name}
                </h1>
                ...
                <div className="mt-4 flex flex-col md:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    {/* BUTTON */}
                    <button className="bg-amber-500 hover:bg-amber-600 text-white py-2 px-4 rounded-lg text-sm transition w-full md:w-auto">
                        View Details
                    </button>
