        ...
        <div className="bg-white border border-gray-100 rounded-2xl hover:shadow-lg transition">
            ...
            <div className="px-4 py-3">
                ...
                <div className="mt-4 flex flex-col md:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    {/* BUTTON */}
                    <button className="bg-amber-500 hover:bg-amber-600 text-white py-1 px-3 md:py-2 md:px-4 rounded-lg text-xs md:text-sm transition w-full md:w-auto font-sans cursor-pointer">
                        View Details
                    </button>
