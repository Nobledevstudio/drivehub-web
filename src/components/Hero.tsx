        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-14">
          ...
          <div className="flex flex-col gap-6 text-center lg:text-left">
            ...
            <div className="inline-flex items-center justify-center lg:justify-start">
              <span className="px-4 py-1 text-xs font-semibold tracking-wide bg-amber-100 text-amber-600 rounded-full">
            ...
            <p className="text-gray-600 text-base md:text-lg max-w-xl mx-auto lg:mx-0">
              Discover verified vehicles, compare prices, and book instantly — all in one seamless platform built for speed and trust.
            </p>
            ...
            <div className="mt-2 flex flex-col sm:flex-row gap-3 p-2 bg-white rounded-xl shadow-md border border-gray-100">
              ...
              <input
                type="text"
                placeholder="Search cars (Toyota, BMW, SUV...)"
                className="flex-1 px-4 py-3 outline-none text-sm"
              />

              <button className="px-6 py-3 bg-amber-400 text-black font-semibold rounded-lg hover:bg-amber-500 transition cursor-pointer">
                Search
              </button>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mt-3">
              ...
              <button className="px-6 py-3 border border-gray-300 text-gray-700 rounded-md font-medium hover:border-amber-400 hover:text-amber-500 transition">
                How It Works
              </button>
